...
session = MySession(hosts={'update.miui.com': get_ip('update.miui.com'), "account.xiaomi.com": get_ip("account.xiaomi.com"), "api.account.xiaomi.com": get_ip("api.account.xiaomi.com")})
